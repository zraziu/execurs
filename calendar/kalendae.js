...
Kalendae.prototype = {
	defaults : {
		...
		weekStart:				1,				/* 1 Понедельник, 0 is Sunday */
		direction:				'any',			/* past, today-past, any, today-future, future */
		directionScrolling:		true,			/* if a direction other than any is defined, prevent scrolling out of range */
		viewStartDate:			null,			/* date in the month to display.  When multiple months, this is the left most */
		blackout:				null,			/* function (date) {return [1,0,1,0,0,0,1][Kalendae.moment(date).day()];}, блокируем даты array of dates, or function to be passed a date */
		...
		useYearNav: 			false,			/* показывать или нет стрелки года */
